...
class Flow0Regressor(nn.Module):
    def __init__(self, npoint, use_instance_norm):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=int(npoint / 4), radius=None, nsample=16, in_channel=128, mlp=[128, 128, 128],
...
class FlowRegressor(nn.Module):
    def __init__(self, npoint, use_instance_norm):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=int(npoint / 4), radius=None, nsample=16, in_channel=128, mlp=[128, 128, 128],
                                          group_all=False, use_instance_norm=use_instance_norm)
        self.sa2 = PointNetSetAbstraction(npoint=int(npoint / 4), radius=None, nsample=16, in_channel=128, mlp=[128, 128, 128],
                                          group_all=False, use_instance_norm=use_instance_norm)
        self.fc = torch.nn.Linear(128, 3)
...
class GlobalCorrLayer(nn.Module):
    def __init__(self, npoint, use_instance_norm):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=int(npoint / 8), radius=None, nsample=8, in_channel=3, mlp=[32, 64, 128],
                                          group_all=False, use_instance_norm=use_instance_norm)
        self.fp1 = PointNetFeaturePropogation(in_channel=128, mlp=[])
...
class EncoderGlob(nn.Module):
    def __init__(self, npoint, use_instance_norm):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=int(npoint / 8), radius=None, nsample=16, in_channel=64, mlp=[128, 128, 128],
                                                 group_all=False, use_instance_norm=use_instance_norm)
        self.sa2 = PointNetSetAbstraction(npoint=int(npoint / 16), radius=None, nsample=8, in_channel=128, mlp=[256, 256, 256],
                                                 group_all=False, use_instance_norm=use_instance_norm)
...
class H0Net(nn.Module):
    def __init__(self, npoint, use_instance_norm):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=int(npoint / 4), radius=None, nsample=4, in_channel=64, mlp=[128, 128, 128],
                                        group_all=False, use_instance_norm=use_instance_norm)
        self.sa2 = PointNetSetAbstraction(npoint=int(npoint / 4), radius=None, nsample=4, in_channel=128, mlp=[128],
...
class FlowStep3D(nn.Module):
    def __init__(self, npoint=512, use_instance_norm=False, loc_flow_nn=8, loc_flow_rad=0.1, k_decay_fact=1.0):
